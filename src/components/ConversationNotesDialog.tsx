        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Welke onderwerpen zijn besproken? (bijv. werkhervatting, behandeling, beperkingen)"
              rows={2}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Welke afspraken zijn gemaakt? (bijv. volgend contact, proefperiode)"
              rows={2}
            />
          </div>
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? 'Opslaan...' : 'Notitie opslaan'}
            </Button>
          </div>
        </form>
      </DialogContent>
