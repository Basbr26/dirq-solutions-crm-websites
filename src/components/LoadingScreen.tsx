        ...
        <div className="relative z-10 text-center space-y-8 sm:space-y-12 w-full max-w-2xl">
          ...
          >
            ...
            <motion.circle
              ...
              transition={{ duration: prefersReducedMotion ? 0.1 : 1.4, ease: "easeInOut" }}
            />
            ...
            <motion.line
              ...
              initial={{ pathLength: 0 }}
              animate={{ pathLength: 1 }}
              transition={{ duration: prefersReducedMotion ? 0.1 : 1.0, ease: "easeInOut", delay: prefersReducedMotion ? 0 : 0.5 }}
            />
            ...
            <motion.text
              ...
              transition={{ duration: prefersReducedMotion ? 0.1 : 0.8, delay: prefersReducedMotion ? 0 : 0.8 }}
            >
              Dirq
            </motion.text>
            ...
            <motion.text
              ...
              transition={{ duration: prefersReducedMotion ? 0.1 : 0.9, delay: prefersReducedMotion ? 0 : 1.1 }}
            >
              Solutions
            </motion.text>
          </motion.svg>
          ...
          <motion.p
            ...
            transition={{ duration: prefersReducedMotion ? 0.1 : 1.2, delay: prefersReducedMotion ? 0 : 2.0 }}
          >
            To make life easier
          </motion.p>
        </div>
