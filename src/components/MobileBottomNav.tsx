...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-t border-border md:hidden supports-[backdrop-filter]:bg-background/60">
      <div className="flex items-center h-16 px-2 safe-area-inset-bottom overflow-x-auto overflow-y-hidden scrollbar-hide">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center flex-shrink-0 h-full gap-1 transition-all duration-300 min-w-[64px] px-2",
                active 
                  ? "text-primary" 
