...
-- ============================================================
-- Add project name, company name, and quote title to notifications
-- Makes notifications more informative and actionable
-- ============================================================
...
'Triggers notification when project stage changes - includes project title and company name';

COMMENT ON FUNCTION notify_quote_status_change() IS 
'Triggers notification when quote status changes - includes quote title and company name';

COMMENT ON FUNCTION notify_lead_stage_change() IS 
'Triggers notification when lead stage changes - includes lead/company name';
